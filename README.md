# Agenda del despacho · Servidor propio
...
No utiliza la plataforma Sites, Cloudflare Workers, D1 ni autenticación de ChatGPT. La base de datos local es la fuente de verdad. Las cuentas tienen hash PBKDF2-SHA256 con sal individual y 600.000 iteraciones; los hashes anteriores de 100.000 siguen siendo verificables. Sesiones de ocho horas, cookies HttpOnly/SameSite Strict y autorización del lado servidor. La primera cuenta requiere un código generado en el servidor.
